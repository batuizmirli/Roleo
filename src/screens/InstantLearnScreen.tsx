...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 28, fontWeight: '900', color: '#FF4D6D', letterSpacing: 2, marginBottom: 20 },
  title: { color: '#FFF', fontSize: 28, fontWeight: '900' },
  subtitle: { color: '#888', fontSize: 15, lineHeight: 22, marginTop: 8, marginBottom: 24 },
  card: { backgroundColor: '#1A1A2E', borderRadius: 16, padding: 16, borderWidth: 1.5, borderColor: '#2A2A3E' },
  cardLabel: { color: '#FFF', fontSize: 15, fontWeight: '700', marginBottom: 10 },
  input: { minHeight: 110, color: '#FFF', fontSize: 15, lineHeight: 22, textAlignVertical: 'top' },
  ...
  button: { backgroundColor: '#FF4D6D', borderRadius: 16, padding: 18, alignItems: 'center', marginTop: 18 },
