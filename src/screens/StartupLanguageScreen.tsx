...
const styles = StyleSheet.create({
  ...
  loadingWrap: { flex: 1, backgroundColor: '#0D0D1A', alignItems: 'center', justifyContent: 'center' },
  logo: { fontSize: 28, fontWeight: '900', color: '#FF4D6D', letterSpacing: 2, marginBottom: 26 },
  ...
  cardActive: { borderColor: '#FF4D6D', backgroundColor: '#1F1520' },
  flag: { fontSize: 22 },
