...
const styles = StyleSheet.create({
  ...
  lessonCard: { backgroundColor: '#16162A', borderRadius: 18, marginBottom: 12, borderWidth: 1.5, borderColor: '#252540', overflow: 'hidden' },
  ...
  lessonBody: { paddingHorizontal: 18, paddingBottom: 18, gap: 14, borderTopWidth: 1, borderTopColor: '#252540', paddingTop: 16 },
  ruleText: { fontSize: 14, color: '#CCC', lineHeight: 22 },
  examplesLabel: { fontSize: 11, fontWeight: '700', color: '#A78BFA', letterSpacing: 1.2 },
  exampleRow: { backgroundColor: '#0A0A12', borderRadius: 12, padding: 14, gap: 4 },
  exSentence: { fontSize: 15, color: '#FFF', fontWeight: '600' },
  exTranslation: { fontSize: 13, color: '#888' },
  tipBox: { flexDirection: 'row', gap: 8, backgroundColor: '#0A0A12', borderRadius: 12, padding: 12, borderWidth: 1, borderColor: '#A78BFA33' },
  tipIcon: { fontSize: 16 },
