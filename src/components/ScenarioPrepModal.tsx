...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20, fontWeight: '900', color: '#F5EDD8', textAlign: 'center', fontFamily: 'PlayfairDisplay_900Black' },
  ...
  resultTitle: { fontSize: 20, fontWeight: '900', color: '#F5EDD8', textAlign: 'center', marginBottom: 24, fontFamily: 'PlayfairDisplay_900Black' },
