...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20, fontWeight: '900', color: '#1A2B3C', textAlign: 'center' },
  location: { fontSize: 13, color: '#9AABB8', textAlign: 'center', marginTop: 4, marginBottom: 20 },
  ...
  primaryBtn: { backgroundColor: '#1B9C5A', borderRadius: 16, padding: 17, alignItems: 'center', marginBottom: 10 },
  ...
  backBtnText: { color: '#B0BEC5', fontSize: 14 },
  ...
  typeLabel: { fontSize: 11, fontWeight: '900', color: '#1B9C5A', letterSpacing: 1 },
  quizProgress: { fontSize: 13, color: '#9AABB8', fontWeight: '700' },
  progressBar: { height: 4, backgroundColor: '#FFFFFF', borderRadius: 2, marginBottom: 20, overflow: 'hidden' },
  progressFill: { height: 4, backgroundColor: '#1B9C5A', borderRadius: 2 },
  ...
  cross: { color: '#1B9C5A', fontWeight: '900', fontSize: 16 },
  ...
  nextBtn: { backgroundColor: '#1B9C5A', borderRadius: 14, padding: 16, alignItems: 'center' },
  nextBtnText: { color: '#1A2B3C', fontSize: 15, fontWeight: '800' },
  resultTitle: { fontSize: 20, fontWeight: '900', color: '#1A2B3C', textAlign: 'center', marginBottom: 24 },
  ...
  statLabel: { fontSize: 11, color: '#9AABB8', marginTop: 4 },
  finalTipBox: { backgroundColor: '#FFFFFF', borderRadius: 12, padding: 14, marginBottom: 20, borderWidth: 1, borderColor: '#E8EDF2' },
