...
const dictionaries: Record<AppLangCode, Dict> = {
  tr: {
    ...
    'scenario.modePickBadge': 'BU SAHNE',
    'scenario.modePickTitle': 'Nasıl cevap vermek istersin?',
    'scenario.modePickSub': 'Seçimin bu prova boyunca sabit kalır; mikrofon ve yazılı yol birbirine karışmaz.',
    'scenario.modePickWrittenTitle': 'Yazılı',
    'scenario.modePickWrittenSub': 'Üç seçenekten birine dokun.',
    'scenario.modePickVoiceTitle': 'Sesli',
    'scenario.modePickVoiceSub': 'Mikrofonla konuş; istersen yukarıdan da seçebilirsin.',
    'scenario.writtenTurnHint': 'Yazılı seçeneklerden birini seçebilirsin.',
    'scenario.voiceLivePlaceholder': 'Konuştukça metin burada belirir.',
    'scenario.voiceLiveEmpty': 'Ses algılanamadı. Tekrar dene veya yazılı seç.',
    'scenario.voiceLiveError': 'Canlı ses tanıma kesildi. Tekrar dene veya yazılı seç.',
  ...
  en: {
    ...
    'scenario.modePickBadge': 'THIS SCENE',
    'scenario.modePickTitle': 'How do you want to answer?',
    'scenario.modePickSub': 'Your pick stays for this rehearsal—voice and written stay separate.',
    'scenario.modePickWrittenTitle': 'Written',
    'scenario.modePickWrittenSub': 'Tap one of three suggested lines.',
    'scenario.modePickVoiceTitle': 'Voice',
    'scenario.modePickVoiceSub': 'Speak into the mic; you can still pick a line above if you need.',
    'scenario.writtenTurnHint': 'Choose one of the written options.',
    'scenario.voiceLivePlaceholder': 'Your words will appear here as you speak.',
    'scenario.voiceLiveEmpty': 'No speech detected. Try again or pick a written line.',
    'scenario.voiceLiveError': 'Live speech recognition stopped. Try again or pick a written line.',
