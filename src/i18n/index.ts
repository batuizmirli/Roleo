...
const dictionaries: Record<AppLangCode, Dict> = {
  tr: {
    ...
    'learn.rhythmPlayed': 'Bugünkü koşuya bağlandı',
    'learn.rhythmAuto': 'Günlük koşuda otomatik gelir',
    'learn.vocab': 'Kelime',
    ...
    'learn.patternsSub': 'Gerçek anda kullanacağın kısa yapılar',
    ...
    'practice.dailyRun': 'GÜNLÜK ROLEO KOŞUSU',
    'practice.modes': 'MODLAR',
    ...
    'practice.miniGames': 'MİNİ OYUNLAR',
    'practice.flashSub': 'Kelimeyi hızlı yakala',
    'practice.trueFakeSub': 'Doğal mı garip mi seç',
    'practice.otherScenes': 'Diğer sahneleri gör →',
    'run.eyebrow': 'BUGÜNKÜ ROLEO LOOP',
    ...
    'mini.questionCount': 'Soru Sayısı',
    'mini.start': 'Başla →',
    'mini.playAgain': 'Tekrar Oyna',
    'mini.accuracy': 'Doğruluk: %{value}',
    'mini.flashReady': 'Kelime refleksi hazır',
    'mini.runDone': 'Run bitti',
    'mini.flashStart': 'Kelime ısınmasını başlat →',
    'mini.toneStart': 'Ton ısınmasını başlat →',
    'mini.correct': 'Doğru! Combo arttı.',
    'mini.wrong': 'Kaçırdın! Combo sıfırlandı.',
  ...
  en: {
    ...
    'home.turnGoal': '{turns} turns, fewer than {awkward} awkward replies', 'home.played': 'played {count}×', 'home.suggestionPlayed': 'Try another scene in Practice.', 'home.suggestionFresh': 'Warm up in Learn, then enter the scene.', 'home.streak': '{count} day streak', 'home.level': 'Lvl {level}',
    'learn.eyebrow': 'LEARN', 'learn.title': 'Practice\nprep', 'learn.subtitle': 'Short supports before you say it in real life.', 'learn.sectionPrep': 'Scene Prep', 'learn.rhythmPlayed': 'Linked to today’s run', 'learn.rhythmAuto': 'Comes into the daily run',
    ...
    'learn.patterns': 'Scene Patterns', 'learn.patternsSub': 'Short structures you will use in the moment', 'learn.phrases': 'Scene Phrases', 'learn.phrasesSub': 'Sentences that help in real moments', 'learn.instant': 'Quick Rehearsal', 'learn.instantSub': 'Try a small speaking moment', 'learn.stories': 'Short Contexts', 'learn.storiesSub': 'Repeat expressions before the scene',
    'practice.eyebrow': 'PRACTICE', 'practice.title': 'Scene\nrehearsals', 'practice.subtitle': 'Rehearse real-life conversations. Today’s scene is the main route.', 'practice.main': 'MAIN REHEARSAL', 'practice.dailyRun': 'DAILY ROLEO RUN', 'practice.modes': 'MODES',
    'practice.sceneMode': 'Scene Mode', 'practice.sceneModeSub': 'Freely rehearse real moments', 'practice.sceneList': 'Scene List', 'practice.sceneListSub': 'Return to your scenes or the list', 'practice.goalTitle': 'Rehearse today’s scene with your goal', 'practice.goalSub': 'Enter the same conversation flow after a short warm-up.', 'practice.miniGames': 'MINI GAMES', 'practice.flashSub': 'Catch the word fast', 'practice.trueFakeSub': 'Choose natural or awkward', 'practice.otherScenes': 'See other scenes →',
    'run.eyebrow': 'TODAY’S ROLEO LOOP', 'run.title.before': 'Warm up', 'run.title.accent': 'first', 'run.title.after': 'then enter the scene.', 'run.subtitle': 'One flow today: word reflex, natural tone check, then real conversation rehearsal.', 'run.selectedScene': 'Selected scene', 'run.steps.1': 'Warm-up · Recognize key words fast', 'run.steps.2': 'Warm-up · Separate natural sentence tone', 'run.steps.3': 'Scene · Rehearse the same scene under pressure', 'run.steps.4': 'Result · See your next focus point', 'run.start': 'Start daily run →', 'run.exit': 'Exit for now',
    ...
    'mini.flashWarmup': '1/2 · Word Warm-up', 'mini.toneWarmup': '2/2 · Tone Warm-up', 'mini.whyNow': 'Why now?', 'mini.questionCount': 'Question Count', 'mini.start': 'Start →', 'mini.playAgain': 'Play Again', 'mini.accuracy': 'Accuracy: {value}%', 'mini.flashReady': 'Word reflex ready', 'mini.runDone': 'Run complete', 'mini.flashStart': 'Start word warm-up →', 'mini.toneStart': 'Start tone warm-up →', 'mini.correct': 'Correct! Combo increased.', 'mini.wrong': 'Missed! Combo reset.', 'mini.fast': 'Be quick and catch the right one.', 'mini.corrected': 'Correct version: {text}',
  },
  es: {},
  fr: {},
  de: {},
...
dictionaries.es = {
  ...
  'home.eyebrow': 'RUTA DIARIA', 'home.hero': 'Tu práctica de {language}\nte espera.', 'home.sceneEyebrow': 'ESCENA DE HOY', 'home.enterScene': 'Entrar en la escena',
  'home.defaultTitle': 'Preparando escena…', 'home.defaultMeta': 'Ensaya una conversación real', 'home.defaultGoal': 'Completa 6 turnos y mantén el flujo', 'home.turnGoal': '{turns} turnos, menos de {awkward} respuestas raras', 'home.played': 'jugada {count}×', 'home.suggestionPlayed': 'Ensaya otra escena en Práctica.', 'home.suggestionFresh': 'Calienta en Aprender y entra en la escena.', 'home.streak': 'racha de {count} días', 'home.level': 'Niv. {level}',
  'learn.eyebrow': 'APRENDER', 'learn.title': 'Preparación\npara la práctica', 'learn.subtitle': 'Apoyos breves antes de decirlo en la vida real.', 'learn.sectionPrep': 'Preparación de escena', 'learn.rhythmPlayed': 'Conectado con la ruta de hoy', 'learn.rhythmAuto': 'Aparece en la ruta diaria',
  ...
  'practice.eyebrow': 'PRÁCTICA', 'practice.title': 'Ensayos\nde escena', 'practice.subtitle': 'Ensaya conversaciones reales. La escena de hoy es la ruta principal.', 'practice.main': 'ENSAYO PRINCIPAL', 'practice.dailyRun': 'RUTA DIARIA ROLEO', 'practice.modes': 'MODOS',
  'practice.sceneMode': 'Modo escena', 'practice.sceneModeSub': 'Ensaya momentos reales libremente', 'practice.sceneList': 'Lista de escenas', 'practice.sceneListSub': 'Vuelve a tus escenas o a la lista', 'practice.goalTitle': 'Ensaya la escena de hoy con tu objetivo', 'practice.goalSub': 'Entra al mismo flujo tras un calentamiento corto.', 'practice.miniGames': 'MINIJUEGOS', 'practice.flashSub': 'Reconoce la palabra rápido', 'practice.trueFakeSub': 'Elige natural o raro', 'practice.otherScenes': 'Ver otras escenas →',
  'run.eyebrow': 'ROLEO LOOP DE HOY', 'run.title.before': 'Primero', 'run.title.accent': 'calienta', 'run.title.after': 'luego entra en la escena.', 'run.subtitle': 'Una sola ruta: reflejo de palabras, control de tono natural y ensayo de conversación real.', 'run.selectedScene': 'Escena seleccionada', 'run.steps.1': 'Warm-up · Reconoce palabras clave rápido', 'run.steps.2': 'Warm-up · Distingue el tono natural', 'run.steps.3': 'Scene · Ensaya bajo presión', 'run.steps.4': 'Result · Mira tu siguiente foco', 'run.start': 'Empezar ruta diaria →', 'run.exit': 'Salir por ahora',
  ...
  'mini.flashWarmup': '1/2 · Calentamiento de palabras', 'mini.toneWarmup': '2/2 · Calentamiento de tono', 'mini.whyNow': '¿Por qué ahora?', 'mini.questionCount': 'Número de preguntas', 'mini.start': 'Empezar →', 'mini.playAgain': 'Jugar de nuevo', 'mini.accuracy': 'Precisión: {value}%', 'mini.flashReady': 'Reflejo de palabras listo', 'mini.runDone': 'Ruta terminada', 'mini.flashStart': 'Empezar calentamiento de palabras →', 'mini.toneStart': 'Empezar calentamiento de tono →', 'mini.correct': '¡Correcto! El combo subió.', 'mini.wrong': 'Fallaste. Combo reiniciado.', 'mini.fast': 'Sé rápido y elige la correcta.', 'mini.corrected': 'Correcto: {text}',
};
...
dictionaries.fr = {
  ...
  'home.eyebrow': 'PARCOURS DU JOUR', 'home.hero': 'Ta pratique de {language}\nt’attend.', 'home.sceneEyebrow': 'SCÈNE DU JOUR', 'home.enterScene': 'Entrer dans la scène',
  'home.defaultTitle': 'Préparation de la scène…', 'home.defaultMeta': 'Répète une conversation réelle', 'home.defaultGoal': 'Termine 6 tours et garde le flow', 'home.turnGoal': '{turns} tours, moins de {awkward} réponses maladroites', 'home.played': 'jouée {count}×', 'home.suggestionPlayed': 'Répète une autre scène dans Pratique.', 'home.suggestionFresh': 'Échauffe-toi dans Apprendre, puis entre en scène.', 'home.streak': 'série de {count} jours', 'home.level': 'Niv. {level}',
  'learn.eyebrow': 'APPRENDRE', 'learn.title': 'Préparation\nde scène', 'learn.subtitle': 'De courts appuis avant de le dire dans la vraie vie.', 'learn.sectionPrep': 'Préparation de scène', 'learn.rhythmPlayed': 'Lié au parcours du jour', 'learn.rhythmAuto': 'Arrive dans le parcours quotidien',
  ...
  'practice.eyebrow': 'PRATIQUE', 'practice.title': 'Répétitions\nde scène', 'practice.subtitle': 'Répète des conversations réelles. La scène du jour est la route principale.', 'practice.main': 'RÉPÉTITION PRINCIPALE', 'practice.dailyRun': 'PARCOURS ROLEO DU JOUR', 'practice.modes': 'MODES',
  'practice.sceneMode': 'Mode scène', 'practice.sceneModeSub': 'Répète librement des moments réels', 'practice.sceneList': 'Liste des scènes', 'practice.sceneListSub': 'Reviens à tes scènes ou à la liste', 'practice.goalTitle': 'Répète la scène du jour avec ton objectif', 'practice.goalSub': 'Entre dans le même échange après un court échauffement.', 'practice.miniGames': 'MINI-JEUX', 'practice.flashSub': 'Attrape le mot vite', 'practice.trueFakeSub': 'Choisis naturel ou maladroit', 'practice.otherScenes': 'Voir d’autres scènes →',
  'run.eyebrow': 'BOUCLE ROLEO DU JOUR', 'run.title.before': 'D’abord', 'run.title.accent': 'échauffe-toi', 'run.title.after': 'puis entre en scène.', 'run.subtitle': 'Un seul flux : réflexe de mots, ton naturel, puis répétition de conversation réelle.', 'run.selectedScene': 'Scène sélectionnée', 'run.steps.1': 'Warm-up · Reconnais vite les mots clés', 'run.steps.2': 'Warm-up · Distingue le ton naturel', 'run.steps.3': 'Scene · Répète sous pression', 'run.steps.4': 'Result · Vois ton prochain focus', 'run.start': 'Lancer le parcours →', 'run.exit': 'Quitter pour l’instant',
  ...
  'mini.flashWarmup': '1/2 · Échauffement vocabulaire', 'mini.toneWarmup': '2/2 · Échauffement du ton', 'mini.whyNow': 'Pourquoi maintenant ?', 'mini.questionCount': 'Nombre de questions', 'mini.start': 'Commencer →', 'mini.playAgain': 'Rejouer', 'mini.accuracy': 'Précision : {value}%', 'mini.flashReady': 'Réflexe vocabulaire prêt', 'mini.runDone': 'Parcours terminé', 'mini.flashStart': 'Lancer l’échauffement vocabulaire →', 'mini.toneStart': 'Lancer l’échauffement du ton →', 'mini.correct': 'Correct ! Le combo augmente.', 'mini.wrong': 'Raté ! Combo remis à zéro.', 'mini.fast': 'Sois rapide et choisis la bonne.', 'mini.corrected': 'Correction : {text}',
};
...
dictionaries.de = {
  ...
  'home.eyebrow': 'TÄGLICHER LAUF', 'home.hero': 'Deine {language}-Übung\nwartet auf dich.', 'home.sceneEyebrow': 'HEUTIGE SZENE', 'home.enterScene': 'Szene betreten',
  'home.defaultTitle': 'Szene wird vorbereitet…', 'home.defaultMeta': 'Übe ein echtes Gespräch', 'home.defaultGoal': '6 Runden abschließen und den Fluss halten', 'home.turnGoal': '{turns} Runden, weniger als {awkward} holprige Antworten', 'home.played': '{count}× gespielt', 'home.suggestionPlayed': 'Übe eine andere Szene in Üben.', 'home.suggestionFresh': 'Wärme dich in Lernen auf, dann geh in die Szene.', 'home.streak': '{count}-Tage-Serie', 'home.level': 'St. {level}',
  'learn.eyebrow': 'LERNEN', 'learn.title': 'Vorbereitung\nfür die Szene', 'learn.subtitle': 'Kurze Hilfen, bevor du es im echten Leben sagst.', 'learn.sectionPrep': 'Szenen-Vorbereitung', 'learn.rhythmPlayed': 'Mit dem heutigen Lauf verbunden', 'learn.rhythmAuto': 'Kommt im täglichen Lauf',
  'practice.eyebrow': 'ÜBEN', 'practice.title': 'Szenen-\nproben', 'practice.subtitle': 'Übe echte Gespräche. Die heutige Szene ist die Hauptroute.', 'practice.main': 'HAUPTPROBE', 'practice.dailyRun': 'TÄGLICHER ROLEO-LAUF', 'practice.modes': 'MODI',
  'practice.sceneMode': 'Szenenmodus', 'practice.sceneModeSub': 'Echte Momente frei üben', 'practice.sceneList': 'Szenenliste', 'practice.sceneListSub': 'Zurück zu Szenen oder Liste', 'practice.goalTitle': 'Übe die heutige Szene mit deinem Ziel', 'practice.goalSub': 'Nach kurzem Warm-up in denselben Gesprächsfluss gehen.', 'practice.miniGames': 'MINISPIELE', 'practice.flashSub': 'Wort schnell erkennen', 'practice.trueFakeSub': 'Natürlich oder holprig wählen', 'practice.otherScenes': 'Andere Szenen sehen →',
  'run.eyebrow': 'HEUTIGER ROLEO LOOP', 'run.title.before': 'Erst', 'run.title.accent': 'aufwärmen', 'run.title.after': 'dann in die Szene.', 'run.subtitle': 'Ein Ablauf: Wortreflex, natürlicher Ton, dann echtes Gespräch üben.', 'run.selectedScene': 'Ausgewählte Szene', 'run.start': 'Täglichen Lauf starten →', 'run.exit': 'Vorerst beenden',
