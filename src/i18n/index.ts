...
const dictionaries: Record<AppLangCode, Dict> = {
  tr: {
    ...
    'run.eyebrow': 'BUGÜNKÜ PROVA AKIŞI',
    ...
    'mini.wrong': 'Şöyle de denenebilir.',
  ...
  en: {
    ...
    'practice.eyebrow': 'PRACTICE', 'practice.title': 'Scene\nrehearsals', 'practice.subtitle': 'Rehearse real-life conversations. Today’s scene is the main route.', 'practice.main': 'MAIN REHEARSAL', 'practice.dailyRun': 'DAILY REHEARSAL FLOW', 'practice.modes': 'REHEARSAL SUPPORTS',
    ...
    'run.eyebrow': 'TODAY’S REHEARSAL FLOW', 'run.title.before': 'Warm up', 'run.title.accent': 'first', 'run.title.after': 'then enter the scene.', 'run.subtitle': 'One flow today: word reflex, natural tone check, then real conversation rehearsal.', 'run.selectedScene': 'Selected scene', 'run.steps.1': 'Warm-up · Recognize key words fast', 'run.steps.2': 'Warm-up · Separate natural sentence tone', 'run.steps.3': 'Scene · Rehearse the same scene under pressure', 'run.steps.4': 'Result · See your next focus point', 'run.start': 'Start rehearsal flow →', 'run.exit': 'Exit for now',
...
dictionaries.es = {
  ...
  'practice.eyebrow': 'PRÁCTICA', 'practice.title': 'Ensayos\nde escena', 'practice.subtitle': 'Ensaya conversaciones reales. La escena de hoy es la ruta principal.', 'practice.main': 'ENSAYO PRINCIPAL', 'practice.dailyRun': 'FLUJO DIARIO DE ENSAYO', 'practice.modes': 'APOYOS DE ENSAYO',
  ...
  'run.eyebrow': 'FLUJO DE ENSAYO DE HOY', 'run.title.before': 'Primero', 'run.title.accent': 'calienta', 'run.title.after': 'luego entra en la escena.', 'run.subtitle': 'Una sola ruta: reflejo de palabras, control de tono natural y ensayo de conversación real.', 'run.selectedScene': 'Escena seleccionada', 'run.steps.1': 'Warm-up · Reconoce palabras clave rápido', 'run.steps.2': 'Warm-up · Distingue el tono natural', 'run.steps.3': 'Scene · Ensaya bajo presión', 'run.steps.4': 'Result · Mira tu siguiente foco', 'run.start': 'Empezar flujo de ensayo →', 'run.exit': 'Salir por ahora',
...
dictionaries.fr = {
  ...
  'practice.eyebrow': 'PRATIQUE', 'practice.title': 'Répétitions\nde scène', 'practice.subtitle': 'Répète des conversations réelles. La scène du jour est la route principale.', 'practice.main': 'RÉPÉTITION PRINCIPALE', 'practice.dailyRun': 'FLUX DE RÉPÉTITION DU JOUR', 'practice.modes': 'APPUIS DE RÉPÉTITION',
  ...
  'run.eyebrow': 'FLUX DE RÉPÉTITION DU JOUR', 'run.title.before': 'D’abord', 'run.title.accent': 'échauffe-toi', 'run.title.after': 'puis entre en scène.', 'run.subtitle': 'Un seul flux : réflexe de mots, ton naturel, puis répétition de conversation réelle.', 'run.selectedScene': 'Scène sélectionnée', 'run.steps.1': 'Warm-up · Reconnais vite les mots clés', 'run.steps.2': 'Warm-up · Distingue le ton naturel', 'run.steps.3': 'Scene · Répète sous pression', 'run.steps.4': 'Result · Vois ton prochain focus', 'run.start': 'Lancer le flux de répétition →', 'run.exit': 'Quitter pour l’instant',
...
dictionaries.de = {
  ...
  'practice.eyebrow': 'ÜBEN', 'practice.title': 'Szenen-\nproben', 'practice.subtitle': 'Übe echte Gespräche. Die heutige Szene ist die Hauptroute.', 'practice.main': 'HAUPTPROBE', 'practice.dailyRun': 'TÄGLICHER PROBENABLAUF', 'practice.modes': 'PROBENHILFEN',
  ...
  'run.eyebrow': 'HEUTIGER PROBENABLAUF', 'run.title.before': 'Erst', 'run.title.accent': 'aufwärmen', 'run.title.after': 'dann in die Szene.', 'run.subtitle': 'Ein Ablauf: Wortreflex, natürlicher Ton, dann echtes Gespräch üben.', 'run.selectedScene': 'Ausgewählte Szene', 'run.start': 'Probenablauf starten →', 'run.exit': 'Vorerst beenden',
